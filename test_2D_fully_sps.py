...
parser.add_argument('--exp', type=str,
                    default='ACDC/method3_batchsize24_fold5', help='experiment_name')
...
def test_single_volume(case, net, test_save_path, FLAGS):
    ...
    org_img_path = "/home1/luyi/WSL4MIS/data/ACDC/ACDC_training/{}.nii.gz".format(case)
...
def Inference(FLAGS):
    ...
    all_volumes = os.listdir("/home1/luyi/WSL4MIS/data/ACDC/ACDC_training_volumes")
    image_list = []
    for ids in test_ids:
        new_data_list = list(filter(lambda x: re.match(
            '{}.*'.format(ids), x) != None, all_volumes))
        image_list.extend(new_data_list)
    snapshot_path = "/home1/luyi/WSL4MIS/model/{}_fold5/{}".format(
        FLAGS.exp,  FLAGS.sup_type)
    test_save_path = "/home1/luyi/WSL4MIS/model/{}_fold5/{}/{}_predictions/".format(
    ...
    save_mode_path = os.path.join(
        snapshot_path, 'iter_51600_dice_0.8764.pth')
